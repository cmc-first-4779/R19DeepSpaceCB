...
public class DeployUpperAutoCommandGroup extends CommandGroup {
  /**
   * Add your docs here.
   */
  public DeployUpperAutoCommandGroup() {
    // Add Commands here:
    ...
    if (Robot.eventHorizonSubsystem.isBallInBox()){
      ...
      addSequential(new TimerCommand(.5));
      addSequential(new ArmSetPositionCommand(RobotMap.ARM_ENCODER_POSITION_ROCKET_UPPER_CARGO  ));
