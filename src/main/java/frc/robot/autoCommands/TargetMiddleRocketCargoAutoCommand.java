...
import frc.robot.commands.Arms.SetArmRocketMiddleCargoCommand;
...
public class TargetMiddleRocketCargoAutoCommand extends CommandGroup {
  ...
  public TargetMiddleRocketCargoAutoCommand() {
    ...
    // arm.
        ...
        addParallel(new SetArmRocketMiddleCargoCommand());
        //  Position the BlackHole / Cargo Handler to the right angle to be square on the Hatch
        addSequential(new SetBlackHoleRocketMiddleCargoCommand());
