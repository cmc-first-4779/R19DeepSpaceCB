...
public static int WARPDRIVE_DISTANCE_LOW_HAB = 400; //placeholder
  ...
  public static double ARM_HEIGHT_INCREMENT = 2500;  //  Increment the arm by 50 when moving by Joystick
  ...
  public static double BLACK_HOLE_MAX_NEGATIVE_ANGLE = -20;  //degrees   Need to test
