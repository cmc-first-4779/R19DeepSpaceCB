...
public static double WARPDRIVE_BUMPER_TURN_INCREMENT = 10;  //degrees.. placeholder.  Used to do minor turn corrections via the bumpers.
  ...
  public static double ARM_HEIGHT_INCREMENT = 7500;  //  Increment the arm by 7500 when moving by Joystick
  ...
  public static double BLACK_HOLE_MAX_POSITIVE_ANGLE = 50;  //degrees   Need to test
